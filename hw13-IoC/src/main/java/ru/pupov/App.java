...
import ru.pupov.appcontainer.api.AppComponentsContainer;
import ru.pupov.config.AppConfig;
import ru.pupov.services.GameProcessor;
...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //AppComponentsContainer container = new AppComponentsContainerImpl("ru.pupov.config");
